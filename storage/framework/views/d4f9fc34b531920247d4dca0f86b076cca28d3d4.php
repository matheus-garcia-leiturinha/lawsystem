<?php echo e(Form::open(array('url' => 'clientes/save',"class" => "clients"))); ?>
        ...
        <?php echo e(Form::label('dados_bancarios', 'Dados Bancários')); ?>



            <div class="block">
                <?php echo e(Form::text('banco','',["class" => "form-control ", "placeholder" => "Banco"])); ?>

                <?php echo e(Form::text('agencia','',["class" => "form-control s1", "placeholder" => "Agência"])); ?>

                <?php echo e(Form::text('conta','',["class" => "form-control s1", "placeholder" => "Conta"])); ?>
